# main.py (Versión con Cheques y Pagos Futuros integrados)
import logging
import asyncio
import json
...
from handlers.core import (
    start_command, cancel_command, unknown_command, 
    handle_main_menu_choice, back_to_main_menu_handler,
    sync_products_command, handle_timeout_state
)
...
from handlers.debts import (
    ...
    start_pay_debt, pay_debt_choose_debt, pay_debt_get_amount, query_debts,
    start_modify_debt, modify_debt_choose_debt, modify_debt_get_amount
)
from handlers.wholesale import (
    ...
    ask_for_modification_amount, apply_modification_payment, start_modify_payment
)
from handlers.balance import (
    query_balance_start_handler, query_balance_year_handler, 
    query_balance_month_handler
)
from handlers.checks import (
    start_checks_menu, checks_menu_handler, checks_get_entity, 
    checks_get_initial_amount, checks_get_commission, checks_get_due_date
)
from handlers.future_payments import (
    start_fp_menu, fp_menu_handler, fp_get_entity, fp_get_product, fp_get_quantity,
